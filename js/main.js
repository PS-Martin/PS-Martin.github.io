...
PlayState.preload = function () {
    ...
    this.game.load.audio('music1', 'audio/Base1.wav');
    this.game.load.audio('musci2', 'audio/Base2.wav');
...
PlayState._handleOrientation = function(e) {
    var x = e.gamma;
    var y = e.beta;
    this.heroo.body.velocity.x += x;
    this.hero.velocity.y += y;
}
